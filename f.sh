...
python -m pip install jedi fastapi kaleido python-multipart uvicorn && python -m pip install libtorrent && apt install python3-libtorrent
...
sudo systemctl restart vsftpd && sudo adduser ftpuser && sudo passwd ftpuser
